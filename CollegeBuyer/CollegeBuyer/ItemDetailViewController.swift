...
extension ItemDetailViewController {
    ...
    @IBAction func report(_ sender: UIButton) {
        self.present(UIAlertController.Factory.getInformController(message: "Report have been sent, we will review it as soon as we can."), animated: true, completion: nil)
    }
}
