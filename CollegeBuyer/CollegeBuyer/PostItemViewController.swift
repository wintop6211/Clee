...
extension PostItemViewController {
    ...
    @IBAction func next(_ sender: UIButton) {
        if images.count < 3 {
            self.present(UIAlertController.Factory.getInformController(message: "Need at least 3 pictures."), animated: true, completion: nil)
        } else {
    ...
    @IBAction func capture(_ sender: UIButton) {
        if images.count == 5 {
            self.present(UIAlertController.Factory.getInformController(message: "Can only upload up to 5 pictures."), animated: true, completion: nil)
        } else {
