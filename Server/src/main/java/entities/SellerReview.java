...
public class SellerReview {
    private Integer idSellerReview;
    ...
    @Id
    @Column(name = "idSellerReview")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    public Integer getIdSellerReview() {
        return idSellerReview;
    }

    public void setIdSellerReview(Integer idSellerReview) {
        this.idSellerReview = idSellerReview;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (idSellerReview != null ? !idSellerReview.equals(that.idSellerReview) : that.idSellerReview != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = idSellerReview != null ? idSellerReview.hashCode() : 0;
